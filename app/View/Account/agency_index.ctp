		...
		<div class="box box-info">
			<div class="box-header">
				...
				<div class="pull-right box-tools">
					<?php echo $this->Html->Link('新規追加', array('action' => 'agencyAdd'), array('class' => 'btn btn-info btn-sm')); ?>
				</div>
			</div>
			<div class="box-body table-responsive">
				...
				<tr>
					...
					<th><?php echo $this->Paginator->sort('aname', '代理店名'); ?></th>
				...
				<tr>
					...
					<td class="actions">
						<?php
						echo $this->Html->link('詳細', array('action' => 'agencyView', $res['MstAdminUser']['id']), array('class' => 'btn btn-default btn-sm'));
						if ($res["MstAdminUser"]['status'] != 2) {
							echo '&nbsp;'.$this->Html->link('編集', array('action' => 'agencyEdit', $res['MstAdminUser']['id']), array('class' => 'btn btn-default btn-sm'));
//							echo $this->Form->postLink('削除', array('action' => 'agencyDelete', $res['MstAdminUser']['id']), array('class' => 'btn btn-default btn-sm'), __('本当に削除してもよろしいですか # %s?', $res['MstAdminUser']['id']));
						} else {
