...
echo $this->Form->input('bot_id', array('type' => 'hidden'));
?>
<div class="row">
				...
				<div class="row" style="margin-bottom: 15px;">
					<div class="col-lg-12 col-md-12">
						...
						<div class="input-group">
							...
							<?php echo $this->Form->input('send_cycle_month_date', array('type' => 'select', 'options' => $type1, 'empty' => '毎月n日', 'class' => 'form-control', 'div' => false, 'label' => false)); ?>
						</div>
						<div class="input-group">
							...
							<?php echo $this->Form->input('send_cycle_week_day', array('type' => 'select', 'options' => $type2, 'empty' => '毎週n曜日', 'class' => 'form-control', 'div' => false, 'label' => false)); ?>
						</div>
						<div class="input-group">
							...
							<?php echo $this->Form->input('send_cycle_day_once', array('type' => 'select', 'options' => $type3, 'empty' => 'n日に1回', 'class' => 'form-control', 'div' => false, 'label' => false)); ?>
						</div>
					</div>
				</div>
				<?php
				echo $this->Form->input('send_method', array('type' => 'select', 'options' => $type4, 'label' => '<i class="fa fa-square"></i>&nbsp;配信方法', 'class' => 'validate[required] form-control'));

				echo $this->Form->input('send_loop_flg', array('type' => 'select', 'options' => $type5, 'label' => '<i class="fa fa-square"></i>&nbsp;ループ設定', 'class' => 'validate[required] form-control'));

				echo $this->Form->input('execute_timeh', array('type' => 'select', 'options' => $type6, 'label' => '<i class="fa fa-square"></i>&nbsp;配信時間', 'class' => 'validate[required] form-control'));
				?>
			</div>
