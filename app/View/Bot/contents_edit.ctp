...
echo $this->Form->input('contents_id', array('type' => 'hidden'));
?>
<div class="row">
...
?>
				...
				if (!empty($this->request->data['MstDiaryBotContents']['hidden_img_url'])) {
					echo '<p>'.$this->Html->Image(Configure::read('IMG_URL').$this->request->data['MstDiaryBotContents']['hidden_img_url'], array('style' => 'max-width: 400px; max-height: 200px;')).'</p>';
				}
				?>
			</div>
