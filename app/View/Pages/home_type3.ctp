...
<div class="row">
	...
	<div class="col-lg-6 col-md-6">
		<div class="box box-info">
			<div class="box-header">
				<h3 class="box-title">サンクス数のトップ5</h3>
			</div>
			<div class="box-body table-responsive">
				...
				<tbody>
				<?php foreach ($data[1] as $id => $res): ?>
				<tr>
					<td><?php echo $this->Html->Link($res['name'], '/account/staffView/'.$id); ?>&nbsp;</td>
					<td><?php echo $res['thanks_receives']; ?>&nbsp;</td>
					<td><?php echo $res['thanks_sends']; ?>&nbsp;</td>
					<td><?php switch ($memberDetails[$id][5]) {
						case 1: echo '<span class="label label-success">'.$memberDetails[$id][6].'</span>'; break;
						case 2: echo '<span class="label label-warning">'.$memberDetails[$id][6].'</span>'; break;
						case 3: echo '<span class="label label-info">'.$memberDetails[$id][6].'</span>'; break;
						case 4: echo '<span class="label label-danger">'.$memberDetails[$id][6].'</span>'; break;
					} ?>&nbsp;</td>
					<td><?php switch ($memberDetails[$id][7]) {
						case 1: echo '<span class="label label-info">'.$memberDetails[$id][8].'</span>'; break;
						case 2: echo '<span class="label label-warning">'.$memberDetails[$id][8].'</span>'; break;
						case 3: echo '<span class="label label-danger">'.$memberDetails[$id][8].'</span>'; break;
					} ?>&nbsp;</td>
					<td class="actions">
						<?php echo '&nbsp;'.$this->Html->Link('レポート', '/report/staffDetail/'.$userSession['id'].'/'.$id.'/'.$from.'/'.$to, array('class' => 'btn btn-info btn-sm')); ?>
					</td>
				</tr>
				<?php endforeach; ?>
				</tbody>
	...
	<div class="col-lg-6 col-md-6">
		<div class="box box-info">
			<div class="box-header">
				<h3 class="box-title">サンクス数のワースト5</h3>
			</div>
			<div class="box-body table-responsive">
				<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover dataTable">
				<thead>
