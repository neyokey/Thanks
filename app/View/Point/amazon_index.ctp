...
<div class="row">
	...
	<?php echo $this->Form->create('TrnPointExchange', array('url' => '/point/amazonPush', 'inputDefaults' => array('div' => 'form-group', 'required' => false))); ?>
	<div class="col-lg-10 col-md-10">
		<div class="box box-info">
			...
			<div class="box-body table-responsive">
				<p>残りAmazonギフト券：<code><?php echo number_format($stocks).'枚('.($stocks * 500).'円分)'; ?></code></p>
				<p>未対応申請数：<code><?php echo number_format($PointExchanges[1]['num']).'枚'; ?></code></p>
				<p><?php echo $this->Html->Link('＞＞補充', '/point/amazonCharge', array('class' => 'btn btn-info')); ?></p>
				...
				<tr>
					<td><?php echo $this->Form->input('TrnPointExchange.exchange_id.'.$res['TrnPointExchange']['exchange_id'], array('type' => 'checkbox', 'class' => 'flat-red', 'label' => false, 'div' => false, 'disabled' => $res['TrnPointExchange']['status'] == 0 ? false : true)); ?></td>
					...
					<td class="actions">
						<?php
						echo $this->Html->link('詳細', array('action' => 'amazonView', $res['TrnPointExchange']['exchange_id']), array('class' => 'btn btn-default btn-sm'));
						?>
					</td>
				</tr>
				<?php endforeach; ?>
			...
			<div class="box-footer clearfix">
				<?php echo $this->Form->submit('チェックした申請の完了処理', array('class' => 'btn btn-success', 'div' => false)); ?>
