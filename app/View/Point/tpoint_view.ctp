...
<div class="row">
	<div class="col-lg-12 col-md-12">
		<div class="box box-info">
			...
			<div class="box-footer clearfix">
				<?php
				echo '<p>'.$this->Html->Link('CSVダウンロード', '/point/tpointDownload/'.$data['TrnPointExchange']['exchange_id'], array('class' => 'btn btn-success', 'style' => 'width: 220px;')).'</p>';
				?>
			</div>
		</div>
	</div>
	...
	<?php
	if ($data['TrnPointExchange']['status'] != 2 || ($data['TrnPointExchange']['status'] == 2 && $data['TrnPointExchange']['exchange_result'] == 1)) {
		echo $this->Form->create('TrnPointExchange', array('url' => '/point/tpointSuccess/'.$data['TrnPointExchange']['exchange_id'], 'inputDefaults' => array('div' => 'form-group', 'required' => false)));
	?>
	...
	<?php
	if ($data['TrnPointExchange']['status'] != 2 || ($data['TrnPointExchange']['status'] == 2 && $data['TrnPointExchange']['exchange_result'] == 0)) {
		echo $this->Form->create('TrnPointExchange', array('url' => '/point/tpointFailed/'.$data['TrnPointExchange']['exchange_id'], 'inputDefaults' => array('div' => 'form-group', 'required' => false)));
	?>
	<div class="col-lg-6 col-md-6">
