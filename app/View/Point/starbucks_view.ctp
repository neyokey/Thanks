...
<div class="row">
	...
	if ($data['TrnPointExchange']['status'] == 0 || ($data['TrnPointExchange']['status'] == 2 && $data['TrnPointExchange']['exchange_result'] == 1)) {
		echo $this->Form->create('TrnPointExchange', array('url' => '/point/starbucksSuccess/'.$data['TrnPointExchange']['exchange_id'], 'inputDefaults' => array('div' => 'form-group', 'required' => false)));
	?>
	...
	if ($data['TrnPointExchange']['status'] == 0 || ($data['TrnPointExchange']['status'] == 2 && $data['TrnPointExchange']['exchange_result'] == 0)) {
		echo $this->Form->create('TrnPointExchange', array('url' => '/point/starbucksFailed/'.$data['TrnPointExchange']['exchange_id'], 'inputDefaults' => array('div' => 'form-group', 'required' => false)));
	?>
	<div class="col-lg-6 col-md-6">
